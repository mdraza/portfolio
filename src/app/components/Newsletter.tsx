export default function Newsletter() {
  return (
    <section className="py-5">
      <div className="bg-white dark:bg-dark/50 rounded-lg overflow-hidden animate-slide-up">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <form className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  type="submit"
                  className="bg-primary cursor-pointer text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors"
                >
                  Subscribe
                </button>
              </form>
